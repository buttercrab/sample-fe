...
import { SPIN_BUTTON_INTL_TRANSLATIONS, } from "./spin-button.intl";
export function SpinButtonRoot(props) {
    ...
    return (<Polymorphic ref={mergeRefs((el) => (ref = el), local.ref)} as="div" role="spinbutton" aria-valuenow={local.value != null && !Number.isNaN(local.value) ? local.value : null} aria-valuetext={textValue()} aria-valuemin={local.minValue} aria-valuemax={local.maxValue} aria-required={props.required || undefined} aria-disabled={props.disabled || undefined} aria-readonly={props.readOnly || undefined} aria-invalid={local.validationState === "invalid" || undefined} onKeyDown={onKeyDown} onFocus={onFocus} onBlur={onBlur} {...others}/>);
}
