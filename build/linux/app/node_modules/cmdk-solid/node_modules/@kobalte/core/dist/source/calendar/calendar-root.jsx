 ...
 */
import { DateFormatter, GregorianCalendar, getDayOfWeek, isSameDay, maxDate, minDate, startOfWeek, toCalendar, toCalendarDate, today, } from "@internationalized/date";
...
export function CalendarRoot(props) {
    ...
    const isCellSelected = (cellDate) => {
        ...
        if (local.selectionMode === "range") {
            ...
            const isInRange = start != null &&
                cellDate.compare(start) >= 0 &&
                end != null &&
                cellDate.compare(end) <= 0;
            return isInRange && isAvailable;
        }
        return (calendarDateValue().some((date) => isSameDay(cellDate, date)) &&
            isAvailable);
    };
