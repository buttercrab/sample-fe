...
export declare function getSelectedDateDescription(translations: CalendarIntlTranslations, value: DateValue, timeZone: string): string;
export declare function getSelectedDateRangeDescription(translations: CalendarIntlTranslations, highlightedRange: {
    start?: DateValue;
    end?: DateValue;
}, anchorDate: DateValue | undefined, timeZone: string): string;
export declare function getVisibleRangeDescription(translations: CalendarIntlTranslations, startDate: DateValue, endDate: DateValue, timeZone: string, isAria: boolean): string;
