...
export function SliderTrack(props) {
    ...
    return (<Polymorphic as="div" ref={mergeRefs(context.registerTrack, props.ref)} onPointerDown={onPointerDown} onPointerMove={onPointerMove} onPointerUp={onPointerUp} {...context.dataset()} {...others}/>);
}
