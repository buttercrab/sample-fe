 ...
 */
import { getFocusableTreeWalker, mergeRefs, } from "@kobalte/utils";
...
export function TabsContent(props) {
    ...
    return (<Show when={presence.isPresent()}>
			<Polymorphic as="div" ref={mergeRefs((el) => {
            presence.setRef(el);
            ref = el;
        }, local.ref)} id={id()} role="tabpanel" tabIndex={tabIndex()} aria-labelledby={context.triggerIdsMap().get(local.value)} data-orientation={context.orientation()} data-selected={isSelected() ? "" : undefined} {...others}/>
		</Show>);
}
