 ...
 */
import { contains, createGenerateId, mergeDefaultProps, mergeRefs, } from "@kobalte/utils";
...
export function MenubarRoot(props) {
    ...
    return (<MenubarContext.Provider value={context}>
			<Polymorphic as="div" ref={mergeRefs((el) => (ref = el), local.ref)} {...others} role="menubar" data-orientation="horizontal"/>
