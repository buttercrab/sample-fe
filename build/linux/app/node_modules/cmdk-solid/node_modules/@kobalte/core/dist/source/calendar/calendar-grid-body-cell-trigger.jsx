...
import { callHandler, focusWithoutScrolling, getWindow, mergeRefs, } from "@kobalte/utils";
...
export function CalendarGridBodyCellTrigger(props) {
    let ref;
    ...
    const isOutsideVisibleRange = () => {
        return (context.date().compare(rootContext.startDate()) < 0 ||
    ...
    return (<Polymorphic as="div" ref={mergeRefs((el) => (ref = el), local.ref)} role="button" tabIndex={tabIndex()} disabled={isDisabled()} aria-disabled={!context.isSelectable() || undefined} aria-invalid={context.isInvalid() || undefined} aria-label={ariaLabel()} data-disabled={isDisabled() || undefined} data-invalid={context.isInvalid() || undefined} data-selected={context.isSelected() || undefined} data-value={context.date().toString()} data-type="day" data-today={context.isDateToday() || undefined} data-weekend={isDateWeekend() || undefined} data-highlighted={context.isFocused() || undefined} data-unavailable={context.isUnavailable() || undefined} data-selection-start={isSelectionStart() || undefined} data-selection-end={isSelectionEnd() || undefined} data-outside-visible-range={isOutsideVisibleRange() || undefined} data-outside-month={isOutsideMonth() || undefined} onPointerEnter={onPointerEnter} onPointerLeave={onPointerLeave} onPointerDown={onPointerDown} onPointerUp={onPointerUp} onClick={onClick} onKeyDown={onKeyDown} onContextMenu={(e) => {
