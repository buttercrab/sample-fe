...
var anatomy = (0, import_anatomy.createAnatomy)("date-picker").parts(
  "root",
  "label",
  "clearTrigger",
  "content",
...
var dom = (0, import_dom_query.createScope)({
  ...
  getFocusedCell: (ctx, view = ctx.view) => (0, import_dom_query.query)(
    dom.getContentEl(ctx),
    `[data-part=table-cell-trigger][data-view=${view}][data-focus]:not([data-outside-range])`
  ),
  getTriggerEl: (ctx) => dom.getById(ctx, dom.getTriggerId(ctx)),
  getContentEl: (ctx) => dom.getById(ctx, dom.getContentId(ctx)),
  getInputEls: (ctx) => (0, import_dom_query.queryAll)(dom.getControlEl(ctx), `[data-part=input]`),
...
function connect(state, send, normalize) {
  ...
  function getMonths(props2 = {}) {
    const { format } = props2;
    return (0, import_date_utils.getMonthNames)(locale, format).map((label, index) => ({ label, value: index + 1 }));
  }
  function getYears() {
    return (0, import_date_utils.getDecadeRange)(focusedValue.year).map((year) => ({
      label: year.toString(),
      value: year
    }));
  }
  ...
  function focusMonth(month) {
    const value = (0, import_date_utils.setMonth)(startValue ?? (0, import_date_utils.getTodayDate)(timeZone), month);
    send({ type: "FOCUS.SET", value });
  }
  function focusYear(year) {
    const value = (0, import_date_utils.setYear)(startValue ?? (0, import_date_utils.getTodayDate)(timeZone), year);
    send({ type: "FOCUS.SET", value });
  }
  function getYearTableCellState(props2) {
    ...
    const cellState = {
      ...
      selectable: !(0, import_date_utils.isDateInvalid)(normalized, min, max),
  ...
  function getMonthTableCellState(props2) {
    ...
    const formatter = (0, import_date_utils.getMonthFormatter)(locale, timeZone);
    const cellState = {
  ...
  function getDayTableCellState(props2) {
    ...
    const formatter = (0, import_date_utils.getDayFormatter)(locale, timeZone);
    const unitDuration = (0, import_date_utils.getUnitDuration)(state.context.visibleDuration);
    const end = visibleRange.start.add(unitDuration).subtract({ days: 1 });
    const cellState = {
      invalid: (0, import_date_utils.isDateInvalid)(value, min, max),
      disabled: disabled2 || (0, import_date_utils.isDateDisabled)(value, visibleRange.start, end, min, max),
      selected: selectedValue.some((date) => (0, import_date_utils.isDateEqual)(value, date)),
      unavailable: (0, import_date_utils.isDateUnavailable)(value, isDateUnavailableFn, locale, min, max) && !disabled2,
      outsideRange: (0, import_date_utils.isDateOutsideVisibleRange)(value, visibleRange.start, end),
      inRange: isRangePicker && (isDateWithinRange(value, selectedValue) || isDateWithinRange(value, hoveredRangeValue)),
      firstInRange: isRangePicker && (0, import_date_utils.isDateEqual)(value, selectedValue[0]),
      lastInRange: isRangePicker && (0, import_date_utils.isDateEqual)(value, selectedValue[1]),
      today: (0, import_date_utils.isTodayDate)(value, timeZone),
      weekend: (0, import_date2.isWeekend)(value, locale),
      formattedDate: formatter.format(value.toDate(timeZone)),
      get focused() {
        return (0, import_date_utils.isDateEqual)(value, focusedValue) && !cellState.outsideRange;
      },
      get ariaLabel() {
  ...
  return {
    ...
    isUnavailable,
    weeks: getMonthWeeks(),
    weekDays: (0, import_date_utils.getWeekDays)((0, import_date_utils.getTodayDate)(timeZone), startOfWeek, timeZone, locale),
    ...
    selectToday() {
      const value = (0, import_date_utils.constrainValue)((0, import_date_utils.getTodayDate)(timeZone), min, max);
    ...
    getYearsGrid(props2 = {}) {
      ...
      return (0, import_utils2.chunk)(getYears(), columns);
    },
    getDecade() {
      const years = (0, import_date_utils.getDecadeRange)(focusedValue.year);
      return { start: years.at(0), end: years.at(-1) };
    },
    getMonthsGrid(props2 = {}) {
      const { columns = 1, format } = props2;
      return (0, import_utils2.chunk)(getMonths({ format }), columns);
    },
    format(value, opts = { month: "long", year: "numeric" }) {
      return new import_date2.DateFormatter(locale, opts).format(value.toDate(timeZone));
    },
    setView(view) {
    ...
    getTableProps(props2 = {}) {
      ...
      return normalize.element({
        ...
        "aria-multiselectable": (0, import_dom_query2.ariaAttr)(state.context.selectionMode !== "single"),
        "data-view": view,
        dir: state.context.dir,
        tabIndex: -1,
        onKeyDown(event) {
    ...
    getDayTableCellProps(props2) {
      ...
      return normalize.element({
        ...
        role: "gridcell",
        "aria-disabled": (0, import_dom_query2.ariaAttr)(!cellState.selectable),
        "aria-selected": cellState.selected || cellState.inRange,
        "aria-invalid": (0, import_dom_query2.ariaAttr)(cellState.invalid),
    ...
    getDayTableCellTriggerProps(props2) {
      ...
      return normalize.element({
        ...
        "aria-disabled": (0, import_dom_query2.ariaAttr)(!cellState.selectable),
        "aria-invalid": (0, import_dom_query2.ariaAttr)(cellState.invalid),
        "data-disabled": (0, import_dom_query2.dataAttr)(!cellState.selectable),
        "data-selected": (0, import_dom_query2.dataAttr)(cellState.selected),
        "data-value": value.toString(),
        "data-view": "day",
        "data-today": (0, import_dom_query2.dataAttr)(cellState.today),
        "data-focus": (0, import_dom_query2.dataAttr)(cellState.focused),
        "data-unavailable": (0, import_dom_query2.dataAttr)(cellState.unavailable),
        "data-range-start": (0, import_dom_query2.dataAttr)(cellState.firstInRange),
        "data-range-end": (0, import_dom_query2.dataAttr)(cellState.lastInRange),
        "data-in-range": (0, import_dom_query2.dataAttr)(cellState.inRange),
        "data-outside-range": (0, import_dom_query2.dataAttr)(cellState.outsideRange),
        "data-weekend": (0, import_dom_query2.dataAttr)(cellState.weekend),
        onClick(event) {
          if (event.defaultPrevented) return;
        ...
        onPointerMove(event) {
          ...
          if (hoveredValue && (0, import_date2.isEqualDay)(value, hoveredValue)) return;
    ...
    getMonthTableCellProps(props2) {
      ...
      return normalize.element({
        ...
        colSpan: columns,
        role: "gridcell",
        "aria-selected": (0, import_dom_query2.ariaAttr)(cellState.selected),
        "data-selected": (0, import_dom_query2.dataAttr)(cellState.selected),
        "aria-disabled": (0, import_dom_query2.ariaAttr)(!cellState.selectable),
        "data-value": value
      });
    ...
    getInputProps(props2 = {}) {
      ...
      return normalize.input({
        ...
        onBeforeInput(event) {
          const { data } = (0, import_dom_event.getNativeEvent)(event);
    ...
    getPresetTriggerProps(props2) {
      const value = Array.isArray(props2.value) ? props2.value : (0, import_date_utils.getDateRangePreset)(props2.value, locale, timeZone);
...
var import_date_utils2 = require("@zag-js/date-utils");
...
var transformContext = (ctx) => {
  ...
  const value = sortDates(ctx.value || []).map((date) => (0, import_date_utils2.constrainValue)(date, ctx.min, ctx.max));
  let focusedValue = value[0] || ctx.focusedValue || (0, import_date_utils2.getTodayDate)(timeZone);
  focusedValue = (0, import_date_utils2.constrainValue)(focusedValue, ctx.min, ctx.max);
  const startValue = (0, import_date_utils2.alignDate)(focusedValue, "start", { months: numOfMonths }, locale);
  return {
    locale,
    numOfMonths,
    focusedValue,
  ...
  return (0, import_core.createMachine)(
    {
      ...
      computed: {
        valueAsString: (ctx2) => ctx2.value.map((date) => (0, import_date_utils2.formatSelectedDate)(date, null, ctx2.locale, ctx2.timeZone)),
        isInteractive: (ctx2) => !ctx2.disabled && !ctx2.readOnly,
        visibleDuration: (ctx2) => ({ months: ctx2.numOfMonths }),
        endValue: (ctx2) => (0, import_date_utils2.getEndDate)(ctx2.startValue, ctx2.visibleDuration),
        visibleRange: (ctx2) => ({ start: ctx2.startValue, end: ctx2.endValue }),
        visibleRangeText(ctx2) {
          const formatter = new import_date3.DateFormatter(ctx2.locale, { month: "long", year: "numeric", timeZone: ctx2.timeZone });
        ...
        isPrevVisibleRangeValid: (ctx2) => !(0, import_date_utils2.isPreviousVisibleRangeInvalid)(ctx2.startValue, ctx2.min, ctx2.max),
        isNextVisibleRangeValid: (ctx2) => !(0, import_date_utils2.isNextVisibleRangeInvalid)(ctx2.endValue, ctx2.min, ctx2.max),
        formattedValue(ctx2) {
          const opts = { timeZone: ctx2.timeZone, day: "2-digit", month: "2-digit", year: "numeric" };
          const formatter = new import_date3.DateFormatter(ctx2.locale, opts);
    ...
    },
    {
      ...
      activities: {
        ...
        setupLiveRegion(ctx2) {
          ...
          ctx2.announcer = (0, import_live_region.createLiveRegion)({ level: "assertive", document: doc });
      ...
      actions: {
        ...
        disableTextSelection(ctx2) {
          (0, import_text_selection.disableTextSelection)({ target: dom.getContentEl(ctx2), doc: dom.getDoc(ctx2) });
        },
        enableTextSelection(ctx2) {
          (0, import_text_selection.restoreTextSelection)({ doc: dom.getDoc(ctx2), target: dom.getContentEl(ctx2) });
        },
        ...
        setDateValue(ctx2, evt) {
          ...
          const value = evt.value.map((date) => (0, import_date_utils2.constrainValue)(date, ctx2.min, ctx2.max));
        ...
        toggleSelectedDate(ctx2, evt) {
          ...
          const index = ctx2.value.findIndex((date) => (0, import_date_utils2.isDateEqual)(date, currentValue));
          if (index === -1) {
        ...
        setPreviousDate(ctx2) {
          set.focusedValue(ctx2, (0, import_date_utils2.getPreviousDay)(ctx2.focusedValue));
        },
        setNextDate(ctx2) {
          set.focusedValue(ctx2, (0, import_date_utils2.getNextDay)(ctx2.focusedValue));
        },
        ...
        focusNextPage(ctx2) {
          const nextPage = (0, import_date_utils2.getNextPage)(
            ctx2.focusedValue,
            ctx2.startValue,
        ...
        focusPreviousPage(ctx2) {
          const previousPage = (0, import_date_utils2.getPreviousPage)(
            ctx2.focusedValue,
            ctx2.startValue,
            ctx2.visibleDuration,
            ctx2.locale,
        ...
        focusNextSection(ctx2, evt) {
          const nextSection = (0, import_date_utils2.getNextSection)(
            ctx2.focusedValue,
            ctx2.startValue,
            evt.larger,
            ctx2.visibleDuration,
        ...
        focusPreviousSection(ctx2, evt) {
          const previousSection = (0, import_date_utils2.getPreviousSection)(
            ctx2.focusedValue,
            ctx2.startValue,
            evt.larger,
            ctx2.visibleDuration,
        ...
        clearFocusedDate(ctx2) {
          set.focusedValue(ctx2, (0, import_date_utils2.getTodayDate)(ctx2.timeZone));
        },
        ...
        focusFirstYear(ctx2) {
          const range = (0, import_date_utils2.getDecadeRange)(ctx2.focusedValue.year);
        ...
        focusParsedDate(ctx2, evt) {
          ...
          const date = (0, import_date_utils2.parseDateString)(evt.value, ctx2.locale, ctx2.timeZone);
          if (!date) return;
        ...
        setStartValue(ctx2) {
          const outside = (0, import_date_utils2.isDateOutsideVisibleRange)(ctx2.focusedValue, ctx2.startValue, ctx2.endValue);
          if (!outside) return;
          const startValue = (0, import_date_utils2.alignDate)(ctx2.focusedValue, "start", { months: ctx2.numOfMonths }, ctx2.locale);
      ...
      compareFns: {
        startValue: import_date_utils2.isDateEqual,
        endValue: import_date_utils2.isDateEqual,
        focusedValue: import_date_utils2.isDateEqual,
        value: isDateEqualFn
      }
    }
  );
...
var isDateEqualFn = (a, b) => {
  ...
  return a.every((date, index) => (0, import_date_utils2.isDateEqual)(date, b[index]));
};
var set = {
  value(ctx, value) {
  ...
  focusedValue(ctx, value) {
    if (!value || (0, import_date_utils2.isDateEqual)(ctx.focusedValue, value)) return;
    const adjustFn = (0, import_date_utils2.getAdjustedDateFn)(ctx.visibleDuration, ctx.locale, ctx.min, ctx.max);
  ...
  adjustedValue(ctx, value) {
    ...
    if ((0, import_date_utils2.isDateEqual)(ctx.focusedValue, value.focusedDate)) return;
    ctx.focusedValue = value.focusedDate;
    invoke.focusChange(ctx);
  },
  view(ctx, value) {
    if ((0, import_utils3.isEqual)(ctx.view, value)) return;
    ctx.view = value;
...
function parse(value) {
  ...
  if (value instanceof Date) {
    return new import_date4.CalendarDate(value.getFullYear(), value.getMonth() + 1, value.getDate());
  }
  return (0, import_date4.parseDate)(value);
}
...
var inputProps = (0, import_types.createProps)()(["index"]);
var splitInputProps = (0, import_utils4.createSplitProps)(inputProps);
var presetTriggerProps = (0, import_types.createProps)()(["value"]);
var splitPresetTriggerProps = (0, import_utils4.createSplitProps)(presetTriggerProps);
var tableProps = (0, import_types.createProps)()(["columns", "id", "view"]);
var splitTableProps = (0, import_utils4.createSplitProps)(tableProps);
var tableCellProps = (0, import_types.createProps)()(["disabled", "value", "columns"]);
var splitTableCellProps = (0, import_utils4.createSplitProps)(tableCellProps);
var viewProps = (0, import_types.createProps)()(["view"]);
var splitViewProps = (0, import_utils4.createSplitProps)(viewProps);
