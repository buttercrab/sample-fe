import { MemoOptions, Accessor, EffectFunction, NoInfer, Setter, AccessorArray, SignalOptions } from 'solid-js';
import { EffectOptions } from '@solid-primitives/utils';

type MemoOptionsWithValue<T> = MemoOptions<T> & {
    value?: T;
};
type AsyncMemoCalculation<T, Init = undefined> = (prev: T | Init) => Promise<T> | T;
/**
 ...
 */
declare function createPureReaction(onInvalidate: VoidFunction, options?: EffectOptions): (tracking: VoidFunction) => void;
/**
 ...
 * lastUpdated() // => 4
 */
declare function createLatest<T extends readonly Accessor<any>[]>(sources: T, options?: MemoOptions<ReturnType<T[number]>>): Accessor<ReturnType<T[number]>>;
/**
 ...
 * lastUpdated() // => [4]
 */
declare function createLatestMany<T extends readonly Accessor<any>[]>(sources: T, options?: EffectOptions): Accessor<ReturnType<T[number]>[]>;
/**
 ...
 */
declare function createWritableMemo<Next extends Prev, Prev = Next>(fn: EffectFunction<undefined | NoInfer<Prev>, Next>): [signal: Accessor<Next>, setter: Setter<Next>];
declare function createWritableMemo<Next extends Prev, Init = Next, Prev = Next>(fn: EffectFunction<Init | Prev, Next>, value: Init, options?: MemoOptions<Next>): [signal: Accessor<Next>, setter: Setter<Next>];
/**
 * @deprecated Please use `createSchedule` from `@solid-primitives/schedule` instead.
 */
declare function createDebouncedMemo<Next extends Prev, Prev = Next>(fn: EffectFunction<undefined | NoInfer<Prev>, Next>, timeoutMs: number): Accessor<Next>;
declare function createDebouncedMemo<Next extends Prev, Init = Next, Prev = Next>(fn: EffectFunction<Init | Prev, Next>, timeoutMs: number, value: Init, options?: MemoOptions<Next>): Accessor<Next>;
/**
 * @deprecated Please use `createSchedule` from `@solid-primitives/schedule` instead.
 */
declare function createDebouncedMemoOn<S, Next extends Prev, Prev = Next>(deps: AccessorArray<S> | Accessor<S>, fn: (input: S, prevInput: S | undefined, prev: undefined | NoInfer<Prev>) => Next, timeoutMs: number): Accessor<Next>;
declare function createDebouncedMemoOn<S, Next extends Prev, Init = Next, Prev = Next>(deps: AccessorArray<S> | Accessor<S>, fn: (input: S, prevInput: S | undefined, prev: Prev | Init) => Next, timeoutMs: number, value: Init, options?: MemoOptions<Next>): Accessor<Next>;
/**
 * @deprecated Please use `createSchedule` from `@solid-primitives/schedule` instead.
 */
declare function createThrottledMemo<Next extends Prev, Prev = Next>(fn: EffectFunction<undefined | NoInfer<Prev>, Next>, timeoutMs: number): Accessor<Next>;
declare function createThrottledMemo<Next extends Prev, Init = Next, Prev = Next>(fn: EffectFunction<Init | Prev, Next>, timeoutMs: number, value: Init, options?: MemoOptions<Next>): Accessor<Next>;
/**
 * @deprecated Please just use `createResource` instead.
 */
declare function createAsyncMemo<T>(calc: AsyncMemoCalculation<T, T>, options: MemoOptionsWithValue<T> & {
    value: T;
}): Accessor<T>;
 ...
 */
declare function createLazyMemo<T>(calc: (prev: T) => T, value: T, options?: EffectOptions): Accessor<T>;
declare function createLazyMemo<T>(calc: (prev: T | undefined) => T, value?: undefined, options?: EffectOptions): Accessor<T>;
type CacheCalculation<Key, Value> = (key: Key, prev: Value | undefined) => Value;
type CacheKeyAccessor<Key, Value> = (key: Key) => Value;
type CacheOptions<Value> = MemoOptions<Value> & {
    size?: number;
};
/**
 ...
 * ```
 */
declare function createMemoCache<Key, Value>(key: Accessor<Key>, calc: CacheCalculation<Key, Value>, options?: CacheOptions<Value>): Accessor<Value>;
declare function createMemoCache<Key, Value>(calc: CacheCalculation<Key, Value>, options?: CacheOptions<Value>): CacheKeyAccessor<Key, Value>;
/**
 ...
 */
declare function createReducer<T, ActionData extends Array<any>>(dispatcher: (state: T, ...args: ActionData) => T, initialValue: T, options?: SignalOptions<T>): [accessor: Accessor<T>, dispatch: (...args: ActionData) => void];

export { type AsyncMemoCalculation, type CacheCalculation, type CacheKeyAccessor, type CacheOptions, type MemoOptionsWithValue, createAsyncMemo, createDebouncedMemo, createDebouncedMemoOn, createLatest, createLatestMany, createLazyMemo, createMemoCache, createPureReaction, createReducer, createThrottledMemo, createWritableMemo };
