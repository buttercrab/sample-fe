...
import { addEventsToActiveMountedPopup, getActiveMountedPopupFromSafeList, removeEventsOnActiveMountedPopup, } from "./thirdPartyPopup";
export const onFocusOutContainer = (state, e) => {
    ...
    if (globalState.closedBySetOpen)
        return;
    if (globalState.overlayMouseDown)
        return;
    if (overlayElement && trapFocus)
        return;
