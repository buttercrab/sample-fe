import { createRoot, createSignal, onCleanup, sharedConfig, } from "solid-js";
...
function CustomPortal(props) {
    const { useShadow, isModal } = props, marker = document.createTextNode(""), mount = props.mount || document.body;
    ...
    if (mount instanceof HTMLHeadElement) {
        ...
        const container = createElement(props.isSVG ? "g" : "div", props.isSVG), renderRoot = useShadow && container.attachShadow
