 ...
 */
import { Key, access, composeEventHandlers, createGenerateId, mergeDefaultProps, mergeRefs, } from "@kobalte/utils";
import { Match, Show, Switch, createMemo, createUniqueId, splitProps, } from "solid-js";
...
export function ListboxRoot(props) {
    ...
    return (<ListboxContext.Provider value={context}>
			<Polymorphic as="ul" ref={mergeRefs((el) => (ref = el), local.ref)} role="listbox" tabIndex={selectableList.tabIndex()} aria-multiselectable={listState().selectionManager().selectionMode() === "multiple"
            ? true
            : undefined} onKeyDown={composeEventHandlers([
            local.onKeyDown,
