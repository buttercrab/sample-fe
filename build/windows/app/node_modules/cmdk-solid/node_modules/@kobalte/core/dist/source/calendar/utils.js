 ...
 * Descriptions
 * -----------------------------------------------------------------------------*/
export function getSelectedDateDescription(translations, value, timeZone) {
...
export function getSelectedDateRangeDescription(translations, highlightedRange, anchorDate, timeZone) {
...
export function getVisibleRangeDescription(translations, startDate, endDate, timeZone, isAria) {
