...
export function DatePickerTrigger(props) {
    ...
    return (<Button.Root ref={mergeRefs(context.setTriggerRef, local.ref)} disabled={isDisabled()} aria-haspopup="dialog" aria-expanded={context.isOpen()} aria-controls={context.isOpen() ? context.contentId() : undefined} aria-label={ariaLabel()} aria-labelledby={ariaLabelledBy()} aria-describedby={context.ariaDescribedBy()} onPointerDown={onPointerDown} onClick={onClick} {...context.dataset()} {...others}/>);
}
