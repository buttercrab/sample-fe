...
export function ListboxItem(props) {
    ...
    const selectableItem = createSelectableItem({
        ...
        allowsDifferentPressOrigin: () => {
            return (listBoxContext.shouldSelectOnPressUp() &&
    ...
    return (<ListboxItemContext.Provider value={context}>
        ...
        ])} onClick={composeEventHandlers([local.onClick, selectableItem.onClick])} onKeyDown={composeEventHandlers([
            local.onKeyDown,
            selectableItem.onKeyDown,
        ])} onMouseDown={composeEventHandlers([
            local.onMouseDown,
            selectableItem.onMouseDown,
        ])} onFocus={composeEventHandlers([local.onFocus, selectableItem.onFocus])} onPointerMove={onPointerMove} {...dataset()} {...others}/>
