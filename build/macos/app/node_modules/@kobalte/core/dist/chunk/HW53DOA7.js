...
import { CollapsibleContent, useCollapsibleContext, CollapsibleRoot, CollapsibleTrigger } from './7N7OIWIM.js';
...
function AccordionRoot(props) {
  ...
  const [local, others] = splitProps(mergedProps, ["id", "ref", "value", "defaultValue", "onChange", "multiple", "collapsible", "shouldFocusWrap", "onKeyDown", "onMouseDown", "onFocusIn", "onFocusOut"]);
