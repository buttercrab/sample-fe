...
var distributePercentage = (props) => {
  ...
  for (let i = props.side === "preceding" ? props.panels.length - 1 : 0; props.side === "preceding" ? i >= 0 : i < props.panels.length; props.side === "preceding" ? i-- : i++) {
    ...
    const availablePercentage2 = props.desiredPercentage - distributedPercentage;
    if (availablePercentage2 === 0) break;
    switch (resizeDirection) {
      case "precedingDecreasing": {
        const minSize = resolveSize(panel2.data.minSize, props.rootSize);
        distributedSizes[i] = Math.max(minSize, panelSize2 + availablePercentage2);
...
var src_default = Resizable;

export { Handle_default as Handle, Panel_default as Panel, Root_default as Root, src_default as default, useResizableContext as useContext, useResizablePanelContext as usePanelContext };
