 ...
 */
import { DateFormatter, GregorianCalendar, getMinimumDayInMonth, getMinimumMonthInYear, toCalendar, } from "@internationalized/date";
import { callHandler, mergeDefaultProps, mergeRefs, } from "@kobalte/utils";
import { Index, createEffect, createMemo, createSignal, on, splitProps, } from "solid-js";
import { asSingleValue } from "../calendar/utils";
import { useFormControlContext } from "../form-control";
import { Polymorphic } from "../polymorphic";
import { useDatePickerContext } from "./date-picker-context";
import { DatePickerInputContext, } from "./date-picker-input-context";
import { convertValue, createPlaceholderDate, getDateFieldFormatOptions, } from "./utils";
...
export function DatePickerInput(props) {
    ...
    const [validSegments, setValidSegments] = createSignal(datePickerContext.value() ? { ...allSegments() } : {});
    ...
    const segments = createMemo(() => {
        ...
        return dateFormatter()
            ...
            const placeholder = isOriginallyEditable
                ...
                : null;
            return {
                type: TYPE_MAPPING[segment.type] ||
                    segment.type,
    ...
    const onFocusOut = (e) => {
        ...
        if (validKeys.length === allKeys.length - 1 &&
    ...
    return (<DatePickerInputContext.Provider value={context}>
			<Polymorphic as="div" role="presentation" ref={mergeRefs((el) => (ref = el), local.ref)} onFocusOut={onFocusOut} aria-labelledby={ariaLabelledBy()} aria-describedby={ariaDescribedBy()} {...datePickerContext.dataset()} {...formControlContext.dataset()} {...others}>
				<Index each={segments()}>
...
export function getPlaceholder(translations, field, value) {
