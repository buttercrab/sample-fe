...
import { Selection, createSelectableCollection, } from "../selection";
import { ComboboxContext, } from "./combobox-context";
import { COMBOBOX_INTL_TRANSLATIONS, } from "./combobox.intl";
/**
...
export function ComboboxBase(props) {
    ...
    const [local, popperProps, formControlProps, others] = splitProps(mergedProps, [
        "translations",
        "itemComponent",
        "sectionComponent",
        "open",
    ...
    const getOptionValue = (option) => {
        ...
        return String(isFunction(optionValue)
            ? optionValue(option)
            : option[optionValue]);
    };
    const getOptionLabel = (option) => {
        ...
        return String(isFunction(optionLabel)
            ? optionLabel(option)
            : option[optionLabel]);
    };
    ...
    createEffect(() => {
        ...
        const didOpenWithoutFocusedItem = isOpen !== lastOpen &&
