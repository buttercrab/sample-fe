export declare function getNextSortedValues(prevValues: number[], nextValue: number, atIndex: number): number[];
/**
...
export declare function stopEventDefaultAndPropagation(event: Event): void;
