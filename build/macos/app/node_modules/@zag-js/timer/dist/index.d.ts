...
declare const anatomy: _zag_js_anatomy.AnatomyInstance<"root" | "item" | "itemValue" | "itemLabel" | "actionTrigger" | "separator">;
...
declare const props: ("id" | "countdown" | "startMs" | "targetMs" | "autoStart" | "interval" | "onTick" | "onComplete" | "getRootNode")[];
declare const splitProps: <Props extends Partial<UserDefinedContext>>(props: Props) => [Partial<UserDefinedContext>, Omit<Props, "id" | "countdown" | "startMs" | "targetMs" | "autoStart" | "interval" | "onTick" | "onComplete" | "getRootNode">];

export { type ActionTriggerProps, type MachineApi as Api, type UserDefinedContext as Context, type ItemProps, type MachineState, type Service, type TickDetails, type Time, type TimePart, type TimerAction, anatomy, connect, machine, parse, props, splitProps };
