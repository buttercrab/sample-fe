...
var anatomy = (0, import_anatomy.createAnatomy)("tagsInput").parts(
  "root",
  "label",
  "control",
  "input",
...
var dom = (0, import_dom_query.createScope)({
  ...
  getTagElements: (ctx) => (0, import_dom_query.queryAll)(dom.getRootEl(ctx), `[data-part=item-preview]:not([data-disabled])`),
  getFirstEl: (ctx) => dom.getTagElements(ctx)[0],
  getLastEl: (ctx) => dom.getTagElements(ctx)[dom.getTagElements(ctx).length - 1],
  getPrevEl: (ctx, id) => (0, import_dom_query.prevById)(dom.getTagElements(ctx), id, false),
  getNextEl: (ctx, id) => (0, import_dom_query.nextById)(dom.getTagElements(ctx), id, false),
  getTagElAtIndex: (ctx, index) => dom.getTagElements(ctx)[index],
  getIndexOfId: (ctx, id) => (0, import_dom_query.indexOfId)(dom.getTagElements(ctx), id),
  ...
  return {
    ...
    getRootProps() {
      return normalize.element({
        ...
        "data-empty": (0, import_dom_query2.dataAttr)(empty),
...
var import_auto_resize = require("@zag-js/auto-resize");
...
var { and, not, or } = import_core.guards;
    ...
    },
    {
      ...
      activities: {
        trackInteractOutside(ctx2, _evt, { send }) {
          return (0, import_interact_outside.trackInteractOutside)(dom.getInputEl(ctx2), {
            exclude(target) {
              return (0, import_dom_query3.contains)(dom.getRootEl(ctx2), target);
            },
        ...
        autoResize(ctx2) {
          ...
          return (0, import_auto_resize.autoResizeInput)(input);
        },
      ...
      actions: {
        ...
        deleteTag(ctx2, evt) {
          ...
          set.value(ctx2, (0, import_utils.removeAt)(ctx2.value, index));
        },
        ...
        setValueAtIndex(ctx2, evt) {
          if (evt.value) {
            ...
            (0, import_utils.warn)("You need to provide a value for the tag");
          }
        },
...
var set = {
  ...
  highlightedId: (ctx, id) => {
    if ((0, import_utils.isEqual)(ctx.highlightedTagId, id)) return;
...
var itemProps = (0, import_types.createProps)()(["index", "disabled", "value"]);
